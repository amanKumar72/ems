  ...
  return (
    <div className="flex-col justify-between p-3 md:p-5 ">
      ...
      <div className="flex justify-between gap-2 ">
        ...
        <button className=" bg-red-600 px-4 py-1 md:px-6 md:py-2 rounded-lg font-semibold text-lg md:text-xl cursor-pointer" onClick={()=>{context.logOut();navigate('/login')}}>
          Log Out
        </button>
      </div>
    </div>
